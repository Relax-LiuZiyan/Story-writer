...
# 学习计划
1. 熟悉赛点资源包内容，并初步学习LCD外设、GPIO模块和EXTI模块，根据进度适当讲解LED外设、按键外设，并布置相应的作业。
...
5. 对上周作业进行快速讲解，学习定时器输出模块，包括占空比和频率多通道都可调功能，并结合外设布置相应的作业。
6. 对上周作业进行快速讲解，学习定时器捕获模块，包括占空比和频率多通道都可调功能，并结合外设布置相应的作业。